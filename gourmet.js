let data = {
  ...
  /////////// 課題3-2 ここからプログラムを書こ
  console.lot(data.address);
  console.lot(data.band);
  console.lot(data.varrier_free);
  console.lot(data.average);
  console.lot(data.code);
  console.lot(data.name);

  console.log(data.capacity);
  console.log(data.card);
  console.log(data.catch);
  console.log(data.charter);
  ...
  console.log(data.free_drink);
  console.log(data.free_food);
  console.log(data.catch);
  console.log(data.code);
  console.log(data.name);
  console.log(data.horigotatsu);
  console.log(data.id);
  console.log(data.karaoke);
  console.log(data.ktai_coupon);
  console.log(data.large_area);
  console.log(data.code);
  console.log(data.name);
  console.log(data.large_service_area);
  console.log(data.code);
  console.log(data.name);
  ...
  console.log(data.middle_area);
  console.log(data.midnight);
  console.log(data.mobile_access);
  console.log(data.name);
  console.log(data.name_kana);
  console.log(data.non_smoking);
  console.log(data.open);
  console.log(data.other_memo);
  console.log(data.parking);
  console.log(data.party_capacity);
  ...
  console.log(data.pricate_room);
  console.log(data.code);
  console.log(data.name);
  console.log(data.shop_datail_memo);
  console.log(data.show);
  console.log(data.small_area);
  console.log(data.code);
  console.log(data.name);
  console.log(data.station_name);
  console.log(data.sub_genre);
  console.log(data.code);
  console.log(data.name); 
  console.log(data.tatami);
  console.log(data.tv);
